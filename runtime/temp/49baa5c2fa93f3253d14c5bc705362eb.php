...
.goods-promotion{background: url(__TEMP__/<?php echo $style; ?>/public/images/seckilling.png);height:35px;line-height: 35px;color:#ffffff;padding-left:15px;}
.sprite-seckilling{height:20px;width:20px;background-image: url(__TEMP__/<?php echo $style; ?>/public/images/i__sprite.png);background-position: -20px 0;display:inline-block;vertical-align: -4px;margin-right:5px;}
.promotion-text{font-size:16px;}
.promotion-time{float:right;padding-right:15px;}
.promotion-time span{display: inline-block;background-color: #fff;border-radius: 2px;color: #0689e1;font-size: 12px;line-height: 16px;text-align: center;padding: 0 1px;min-width: 14px;position: relative;top: -1px;}
.rightshow{content: '';display: inline-block;clear: both;float:right;}
.receive-coupons .coupon{width:auto;float:left;width:86.5%;}
...
.prom-gift .dt{width: 10%;}
.goods-price .realy-price{width:100%;height:35px;}
.realy-price .now-prices{width:100%;}
.goods-price .realy-price .price{width:10%;line-height:30px;}
.goods-price .realy-price .now-prices .p-price{font-weight:normal;font-size:20px;vertical-align: middle;}
.show-price{width:100%;}
.goods-price .price {width: 10%;display: block;float: left;}
...
.receive-coupons .title {width: 10%;margin-right: 10px;}
.freight .dt{margin-right: 15px;}
.choose dl dd{margin-left:20px;}
...
<!-- 			<li><a class="menu-hd home" href="<?php echo __URL('SHOP_MAIN'); ?>" target="_top"><i></i><?php echo lang('shop_index'); ?></a></li> -->
		...
		<!--	<li class="menu-item">
				<div class="menu">
					<a class="menu-hd we-chat" href="javascript:;" target="_top">&lt;!&ndash; <i></i> &ndash;&gt;<?php echo lang('attention_mall'); ?><b></b>
					</a>
...
<div id="MagnifierWrap">
	...
	<div class="spec-items">
		...
		<div class="detail-info">
			...
			<!-- 限时折扣 -->
			<input type="hidden" id="end_time" value="<?php echo getTimeStampTurnTime($goods_info['promotion_detail']['end_time'] ); ?>"/>
			<div class="goods-promotion">
				<i class="sprite-seckilling"></i>
				<span class="promotion-text"><?php echo lang('goods_discount'); ?></span>
				<div class="promotion-time"><?php echo lang('goods_distance_ends'); ?>
					...
					<span class="c-red js-sec">00</span>  <?php echo lang('second'); ?>
					<span class="settime" starttime="<?php echo getTimeStampTurnTime($goods_info['promotion_detail']['start_time'] ); ?>" endtime="<?php echo getTimeStampTurnTime($goods_info['promotion_detail']['end_time'] ); ?>" ></span>
				</div>
			</div>
			<div class="goods-price">
				...
				<div class="realy-price">
					<div class="now-prices">
						...
						<?php endif; ?>
						<strong class="p-price second-color" style="font-size:12px;padding: 1px 5px;color: #fff;margin: 3px 0 0 5px;background-color: #FF7200;border-radius:1px;display:inline-block;"><?php echo $goods_info['promotion_detail']['discount_name']; ?></strong>
					</div>
				</div>
				...
				<?php endif; if(in_array(($goods_info['point_exchange_type']), explode(',',"0,2"))): ?>
					...
					<?php endif; endif; if($goods_info['give_point'] != 0): ?>
				<div class="realy-price">
					<div class="now-prices">
						<span class="price"><?php echo lang('goods_gift_points'); ?></span>
						<strong class="p-price second-color" style="font-size:12px;line-height:30px;padding: 1px 5px;color: #fff;margin-left: 5px;background-color: #FF7200;"><?php echo $goods_info['give_point']; ?>&nbsp;<?php echo lang('points'); ?></strong>
					</div>
				</div>
							...
							<li data-push="2" class="p-list">
								<div class="p-img">
									<a href="<?php echo __URL('SHOP_MAIN/goods/goodsinfo','goodsid='.$to['goods_id']); ?>" target="_blank" style="display: block;width: 130px;height: 130px;">
										<img width="130" height="130" src="<?php echo __IMG($default_goods_img); ?>" class="lazy_load" data-original="<?php echo __IMG($to['pic_cover_mid']); ?>" title="<?php echo $to['goods_name']; ?>">
									</a>
								</div>
								<div class="p-name">
		...
		if(end_date != undefined && end_date != ''){
			...
			var timer = setInterval(function(){
				if (sys_second > 1) {
					...
					$(".promotion-time").html("<?php echo lang('activity_over'); ?>！");
					clearInterval(timer);
				}
			}, 1000);
		}
