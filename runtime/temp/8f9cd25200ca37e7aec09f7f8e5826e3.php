<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:50:"template/adminblue\Goods\updateGoodsAttribute.html";i:1531363025;s:28:"template/adminblue\base.html";i:1536464688;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1531363025;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
&lt;!&ndash; 					<p> &ndash;&gt;
&lt;!&ndash; 						<span id="copyright_desc"></span> &ndash;&gt;
&lt;!&ndash; 						<br/> &ndash;&gt;
&lt;!&ndash; 						<a id="copyright_companyname" style="color: #333" target="_blank"></a> &ndash;&gt;
&lt;!&ndash; 						<br/> &ndash;&gt;
&lt;!&ndash; 						<span id="copyright_meta"></span> &ndash;&gt;
&lt;!&ndash; 					</p> &ndash;&gt;
				</footer>
			</div>-->
		</div>
...
<div class="set-style">
	...
	<dl>
		...
		<dd>
			<input id="sort" type="number" value="<?php echo $info['sort']; ?>" class="input-common harf"/>
		</dd>
	</dl>
	<dl>
	...
	<dl>
		...
		<dd>
			<div class="guige_list">
				<?php if(is_array($goodsguige['data']) || $goodsguige['data'] instanceof \think\Collection || $goodsguige['data'] instanceof \think\Paginator): if( count($goodsguige['data'])==0 ) : echo "" ;else: foreach($goodsguige['data'] as $key=>$v): if(in_array(($v['spec_id']), is_array($info['spec_id_array'])?$info['spec_id_array']:explode(',',$info['spec_id_array']))): ?>
						<a href="javascript:;" value="<?php echo $v['spec_id']; ?>"><?php echo $v['spec_name']; ?><img src="ADMIN_IMG/delete_ico.png" alt="" /></a>
	...
	<dl>
		...
		<dd>
			<div class="brand_list">
				...
				<?php if(is_array($brand_list) || $brand_list instanceof \think\Collection || $brand_list instanceof \think\Paginator): if( count($brand_list)==0 ) : echo "" ;else: foreach($brand_list as $key=>$v): if(in_array(($v['brand_id']), is_array($info['brand_id_array'])?$info['brand_id_array']:explode(',',$info['brand_id_array']))): ?>
					<a href="javascript:;" value="<?php echo $v['brand_id']; ?>" ><?php echo $v['brand_name']; ?><img src="ADMIN_IMG/delete_ico.png" alt="" /></a>
					<?php endif; endforeach; endif; else: echo "" ;endif; ?>
		...
		<table class="table-class" id='attrList'>
			...
			<tbody>
				...
				<tr class="value_data old_data">
					<td></td>
					<td>
						<input type="number" name="value_sort" value="<?php echo $v['sort']; ?>" class="input-common short" onchange="updateAttrvalue('value_sort',<?php echo $v['attr_value_id']; ?>,this);" />
					</td>
					<td>
						<input type="text" name="value_name" class="input-common middle" value="<?php echo $v['attr_value_name']; ?>" onchange="updateAttrvalue('value_name',<?php echo $v['attr_value_id']; ?>,this);" />
						
					</td>
					<td>
						<select class="selectbox select-common middle" id="type_box_<?php echo $v['attr_value_id']; ?>" value="<?php echo $v['type']; ?>" onchange="updateAttrvalue('type_box',<?php echo $v['attr_value_id']; ?>,this);">
					...
					<td style="text-align: center;">
						<?php if($v['is_search'] == 0): ?>
							<a href="javascript:;" class="is_search" is_search="0" onclick="updateAttrvalue('is_search',<?php echo $v['attr_value_id']; ?>,this);">
								<img src="ADMIN_IMG/un_checked.png" alt="" width="15"/>
						<?php else: ?>
							<a href="javascript:;" class="is_search" is_search="1" onclick="updateAttrvalue('is_search',<?php echo $v['attr_value_id']; ?>,this);">
								<img src="ADMIN_IMG/checked.png" alt="" width="15"/>
							</a>
						<?php endif; ?>
					</td>
					<td id="value_<?php echo $v['attr_value_id']; ?>" style="word-break:break-all;" title="<?php echo $v['value']; ?>">
						<?php echo $v['value']; ?>
					</td>
					...
					<td style="text-align: center;">
						...
						<a href="javascript:;" onclick="delOldAttributeValue(this, <?php echo $v['attr_id']; ?>, <?php echo $v['attr_value_id']; ?>)">删除</a>
					</td>
