<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:46:"template/adminblue\Config\addRoutingRules.html";i:1531363025;s:28:"template/adminblue\base.html";i:1536464688;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1531363025;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
function save(){
	...
	if(vertify(rule,route)){
		if(!is_sub){
			...
			$.ajax({
				type : "post",
				url : "<?php echo __URL('ADMIN_MAIN/config/addRoutingRules'); ?>",
				data : {
					"rule" : rule,
					"route" : route,
