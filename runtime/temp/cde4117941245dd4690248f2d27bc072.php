<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:52:"template/adminblue\System\updateShopAdvPosition.html";i:1531363025;s:28:"template/adminblue\base.html";i:1536464688;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1531363025;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
		...
		<dd>
			<p>
				<select id="ap_class" name="account" class="form-control m-b input-common">
					...
					<option value="4" <?php if($info['ap_class'] == 4): ?>selected<?php endif; ?>>代码</option>
				</select>
			</p>
		</dd>
	</dl>
		...
		<dd>
			<p>
				<label class="radio inline normal">
					<i class="radio-common <?php if($info['type'] == 1): ?>selected<?php endif; ?>"><input type="radio" name="type" id="type1" value="1" <?php if($info['type'] == 1): ?> checked <?php endif; ?>></i>
					<span>PC端</span>
				</label>
				<label class="radio inline normal">
					<i class="radio-common <?php if($info['type'] == 2): ?>selected<?php endif; ?>"><input type="radio" name="type" id="type2" value="2" <?php if($info['type'] == 2): ?> checked <?php endif; ?>></i> 
					<span>手机端</span>
				</label>
			</p>
		</dd>
	...
	<div class="data-image">
			...
			<dd>
				<p id="ap_display">
					<label class="radio normal inline">
						<i class="radio-common <?php if($info['ap_display'] == 0): ?>selected<?php endif; ?>"><input type="radio" name="ap_display" id="ap_display0" value="0" <?php if($info['ap_display'] == 0): ?>checked<?php endif; ?>></i>
						<span>可以发布多条并幻灯展示</span>
					</label>
					<label class="radio normal inline">
						<i class="radio-common <?php if($info['ap_display'] == 1): ?>selected<?php endif; ?>"><input type="radio" name="ap_display" id="ap_display1" value="1" <?php if($info['ap_display'] == 1): ?>checked<?php endif; ?>></i> 
						<span>可以发布多条广告并随机展示</span>
					</label>
					<label class="radio normal inline">
						<i class="radio-common <?php if($info['ap_display'] == 2): ?>selected<?php endif; ?>"><input type="radio" name="ap_display" id="ap_display2" value="2" <?php if($info['ap_display'] == 2): ?>checked<?php endif; ?>></i>
		...
		<dl>
			...
			<dd>
				<p><input id="ap_width" type="number" value="<?php echo $info['ap_width']; ?>" class="input-common harf"><em class="unit">PX</em></p>
		...
		<dl>
			...
			<dd>
				<p><input id="ap_height" type="number" value="<?php echo $info['ap_height']; ?>" class="input-common harf"><em class="unit">PX</em></p>
			...
			<dd>
				<div class="upload-btn-common">
					<div>
						...
						<input type="hidden" id="adv" value="<?php echo $info['default_content']; ?>">
					</div>
					
					<input type="text" id="text_adv" class="input-common" readonly="readonly" value="<?php echo $info['default_content']; ?>">
					<em>上传</em>
					<img id="preview_adv" src="__STATIC__/blue/img/upload-common-select.png" data-src="<?php echo __IMG($info['default_content']); ?>" data-html="true" data-container="body" data-placement="top" data-trigger="manual" data-original-title="" title="">
				</div>
		...
		<dl>
			<dt>默认背景色：</dt>
			<dd>
				<input id="ap_background_color" type="color" style="width:60px;height:25px;" value="<?php echo $info['ap_background_color']; ?>" class="input-common-color" />
			</dd>
		</dl>
	</div>
	<dl>
		...
		$.ajax({
			...
			success : function(data) {
				if (data["code"] > 0) {
					...
					location.href = "<?php echo __URL('ADMIN_MAIN/system/shopadvpositionlist'); ?>";
				}else{
					showTip("编辑失败",'error');
				}
			}
