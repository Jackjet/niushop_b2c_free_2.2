<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:49:"template/adminblue\Config\updateRoutingRules.html";i:1531363025;s:28:"template/adminblue\base.html";i:1536464688;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1531363025;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd>
			<input type="text" class="input-common" id="rule" onchange="url_route_if_exists('rule',this);" onKeyUp="value=value.replace(/[^\d|\w]/g,'')" value="<?php echo $routeDetail['rule']; ?>" maxlength="100" onpaste="return false"/>
			<p class="hint"></p>
	...
	<dl>
		...
		<dd>
			<input type="text" class="input-common" id="route" onchange="url_route_if_exists('route',this);" value="<?php echo $routeDetail['route']; ?>"  maxlength="150" />
	...
	<dl>
		...
		<dd>
			<select id="route_model" class="select-common">
				<option value="1" <?php if($routeDetail['route_model'] == 1): ?>selected<?php endif; ?>>shop</option>
				<!-- <option value="2" <?php if($routeDetail['route_model'] == 2): ?>selected<?php endif; ?>>wap</option>
				<option value="3" <?php if($routeDetail['route_model'] == 3): ?>selected<?php endif; ?>>admin</option> -->
			</select>
		</dd>
	</dl>
	<dl>
		<dt>是否启用：</dt>
		<dd>
			<p><input type="checkbox" id="is_open" class="checkbox" <?php if($routeDetail['is_open'] == 1): ?>checked<?php endif; ?>></p>
		</dd>
	</dl>
	<dl>
		<dt>描述：</dt>
		<dd>
			<textarea name="" id="remark" class="textarea-common"><?php echo $routeDetail['remark']; ?></textarea>
		</dd>
	</dl>	
	<dl>
		<dt></dt>
	...
	<input type="hidden" id="routeid" value="<?php echo $routeDetail['routeid']; ?>">
</div>
<script>
//关键字
...
function url_route_if_exists(type, event){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/config/url_route_if_exists'); ?>",
		async : false,
		data : {
			"type" : type,
			"value" : value
...
function save(){
	...
	if(vertify(rule,route)){
		if(!is_sub){
			...
			$.ajax({
				type : "post",
				url : "<?php echo __URL('ADMIN_MAIN/config/updateRoutingRule'); ?>",
				data : {
					"routeid" : routeid,
					"rule" : rule,
					"route" : route,
