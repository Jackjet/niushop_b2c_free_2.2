					...
					<div id="goods_attr_list" class="goods-detail-con goods-detail-tabs" style="display:none;">
						<?php if(count($goods_info['goods_attribute_list']) > 0): ?>
							<table cellspacing="0">
								...
								<?php
								dump($goods_info['goods_attribute_list']);
								 foreach($goods_info['goods_attribute_list'] as $vo): if(!(empty($vo['attr_value_name']) || (($vo['attr_value_name'] instanceof \think\Collection || $vo['attr_value_name'] instanceof \think\Paginator ) && $vo['attr_value_name']->isEmpty()))): ?>
										<tr>
