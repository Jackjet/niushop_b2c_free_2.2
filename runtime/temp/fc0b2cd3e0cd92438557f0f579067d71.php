<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:48:"template/adminblue\Promotion\updateDiscount.html";i:1531363025;s:28:"template/adminblue\base.html";i:1536464688;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:51:"template/adminblue\Promotion\goodsSelectDialog.html";i:1531363025;s:34:"template/adminblue\pageCommon.html";i:1531363025;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	...
	<dl>
		<dt>活动有效期：</dt>
		<dd>
			<input class="input-medium input-common harf" type="text" id="start_time" value="<?php echo getTimeStampTurnTime($info['start_time'] ); ?>" style="width:250px;"onclick="WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd HH:mm:ss'})">
			<span class="mlr5">-</span> 
			<input class="input-medium input-common harf" size="15"type="text" id="end_time" value="<?php echo getTimeStampTurnTime($info['end_time'] ); ?>" style="width:250px;"onclick="WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd HH:mm:ss'})">
	...
	<dl>
		...
		<dd>
			<label class="radio inline normal decimal_reservation_number">
				<i class="checkbox-common <?php if($info['decimal_reservation_number'] == 0): ?>selected<?php endif; ?>">
					<input type="checkbox" name="decimal-reservation-number" value="0"  <?php if($info['decimal_reservation_number'] == 0): ?>checked<?php endif; ?>>
				</i>
				<span>抹去角和分</span>
			</label>
			<label class="radio inline normal decimal_reservation_number">
				<i class="checkbox-common  <?php if($info['decimal_reservation_number'] == 1): ?>selected<?php endif; ?>">
					<input type="checkbox" name="decimal-reservation-number" value="1"  <?php if($info['decimal_reservation_number'] == 1): ?>checked<?php endif; ?>>
				</i>
				<span>抹去分</span>
			</label>
		</dd>
	...
	<span id="goods-condition">
		...
		<input type="hidden" id="goods_id_array" value="<?php echo $info['goods_id_array']; ?>">
		...
		<input type="hidden" id="selected_data" value='<?php echo $selected_data; ?>'>	
	</span>
	<style>
...
function open_Goods_Select_List(){
	...
	layer_index = layer.open({
		  ...
		  shade: 0.8,
		  area: ['960px', '570px'],
		  content: __URL('ADMIN_MAIN/promotion/goodsSelectList?type=' + type + '&data=' + data),
		});
...
function refresh_discount(){
	var goods_selected_array = <?php echo $info; ?>.goods_list;
